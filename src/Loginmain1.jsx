...
export default function BasicGrid1() {
    ...
    const buttonStyle = { 
      width:"110px",borderRadius:"0px 20px 20px 0px",backgroundColor:"white",color:"#146C94",border:"1px solid #146C94 ",  Cursor:"text", TextDecoration: "None"
      // Replace 'your_desired_color' with the color you want
    };
    const buttonStyles = {
      width:"110px",borderRadius:"20px 0px 0px 20px",backgroundColor:"#146C94",color:"white",border:"1px solid #146C94 ",  Cursor:"text", TextDecoration: "None" // Replace 'your_desired_color' with the color you want
    };
    const signup = {
      position:"relative",
    color:"white",
  ...
  return (
    ...
    <Box sx={{ flexGrow: 3 }}>
      ...
      <Grid sx={{marginLeft:"502px",marginTop:"50px"}}>
        ...
        <Grid item xs={4} >
          ...
          <Typography  className="heads"variant='h4'> Admin Login</Typography>
    ...
    <Button style={signup} variant="contained" ><Link to="/register" style={{color:"white"}}> Sign Up</Link></Button>
     </Styles>
          </Item1>
        </Grid>
      </Grid>

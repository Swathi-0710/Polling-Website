...
const Adminregisterform = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.password) {
      newErrors.password = <h1>'Password is required'</h1>;
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
     ...
     <InputAdornment position="start"><PersonIcon  size="small" className="iconstyle"/></InputAdornment>),}} />
          ...
          <OutlinedInput sx={{paddingLeft:"34px"}} InputProps={{startAdornment: (
           ...
           className="TxtFstyles"
            ...
            endAdornment={
              <InputAdornment position="end">
                <LockIcon  size="small" className="iconstyle1"/>
                <IconButton onClick={handleClickShowPasswords}onMouseDown={handleMouseDownPasswords}edge="end">{showPasswords ? <VisibilityOff sx={{color:"#4682b4"}}/> : <Visibility sx={{color:"#4682b4"}} />}
                </IconButton>
              </InputAdornment>
      ...
      <Styles>
      <Button type="submit"   className="buttonstyle"variant="contained" color="primary">
        Register
      </Button>
      </Styles>
     ...
     <Grid  sx={{position:"relative",marginLeft:"540px"}}>
        <Item1>
         ...
         <Typography className='imagestyle' variant="h4">New Here?</Typography>
          ...
          <Button className="imagestyling" variant="contained" onSubmit={handleSubmit}>Sign Up</Button>
           </Styles>
         </Item1>
          </Grid>
      </Grid>
